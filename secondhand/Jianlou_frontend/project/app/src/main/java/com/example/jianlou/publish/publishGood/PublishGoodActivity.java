...
public class PublishGoodActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private GridImageAdapter.onAddPicClickListener onAddPicClickListener = new GridImageAdapter.onAddPicClickListener() {
        ...
        public void onAddPicClick() {
            ...
            if(selectList != null){
                Toast.makeText(PublishGoodActivity.this, String.valueOf(selectList.size()), Toast.LENGTH_SHORT).show();
            }
        }
    };
    ...
    public void PublishGood_publish() {
        ...
        // 修复：拆分校验+修正提示文案
        if (publish_content.length() == 0) {
            Toast.makeText(this, "必须填写商品描述", Toast.LENGTH_SHORT).show();
                    ...
                    if (response.body() != null) {
                        ...
                        switch (responseData) {
                            case "success":
                                ...
                                break;
                            case "failed":
                                outputMessage("发布失败（商品重复/参数错误）");
                                break;
                            default:
                                outputMessage("未知错误：" + responseData);
                        }
                    }
                } else {
