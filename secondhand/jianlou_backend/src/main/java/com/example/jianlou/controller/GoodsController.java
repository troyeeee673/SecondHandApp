        ...
        for (Goods goods : goodsList) {
            ...
            if (images != null && !images.isEmpty()) {
                ...
                if (imagePath.startsWith("/upload/")) {
                    goodsMap.put("image", "http://192.168.117.31:8080" + imagePath);
                } else if (imagePath.startsWith("http")) {
                    goodsMap.put("image", imagePath);
                } else {
                    goodsMap.put("image", "http://192.168.117.31:8080/upload/" + imagePath);
                }
            } else {
                goodsMap.put("image", "");
            }
        ...
        try {
            ...
            if (start < total) {
                ...
                for (Goods goods : pageData) {
                    ...
                    if (!imgUrl.isEmpty()) {
                        goodsMap.put("image", imgUrl.startsWith("/upload/") ? "http://192.168.117.31:8080" + imgUrl : "http://192.168.117.31:8080/upload/" + imgUrl);
                    } else {
                        goodsMap.put("image", "");
                    }
                    result.add(goodsMap);
        ...
        try {
            ...
            if (start < total) {
                ...
                for (Goods goods : pageData) {
                    ...
                    String imgUrl = (images != null && !images.isEmpty()) ? images.get(0).getImage() : "";
                    if (!imgUrl.isEmpty()) {
                        goodsMap.put("image", "http://192.168.117.31:8080" + (imgUrl.startsWith("/upload/") ? imgUrl : "/upload/" + imgUrl));
                    } else {
                        goodsMap.put("image", "");
                    }
                    result.add(goodsMap);
                        ...
                        if (goods != null) {
                            ...
                            if (images != null && !images.isEmpty()) {
                                ...
                                if (firstImage != null && firstImage.getImage() != null) {
                                    ...
                                    if (imagePath.startsWith("/upload/")) {
                                        imageUrl = "http://192.168.117.31:8080" + imagePath;
                                    } else if (imagePath.startsWith("http://") || imagePath.startsWith("https://")) {
                                        imageUrl = imagePath;
                                    } else {
                                        imageUrl = "http://192.168.117.31:8080/upload/" + imagePath;
                                    }
                                }
                            }
            ...
            for (Order order : orders) {
                ...
                if (goods != null) {
                    ...
                    if (images != null && !images.isEmpty()) {
                        String imagePath = images.get(0).getImage();
                        if (imagePath.startsWith("/upload/")) {
                            orderObj.put("goods_image", "http://192.168.117.31:8080" + imagePath);
                        } else {
                            orderObj.put("goods_image", "http://192.168.117.31:8080/upload/" + imagePath);
                        }
                    } else {
                        orderObj.put("goods_image", "");
                    }
